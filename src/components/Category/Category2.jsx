    ...
    <div className="py-5">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* First col */}
          <div className="sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/70 to-gray-100 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              <div className="mb-4">
                <p className="mb-[2px] text-white">Enjoy with</p>
                <p className="text-2xl font-semibold mb-[2px]">Best Selling</p>
                <p className="text-4xl xl:text-5xl font-bold opacity-50 mb-3">
                  Play Stations
                </p>
                <Button
                  text="Browse"
          ...
          <div className="py-10 pl-5 bg-gradient-to-br from-brandGreen/90 to-brandGreen/90 text-white rounded-3xl relative h-[320px] flex items-start">
            <div>
              <div className="mb-4">
                <p className="mb-[2px] text-white">Enjoy with</p>
                <p className="text-2xl font-semibold mb-[2px]">Best Selling</p>
                <p className="text-4xl xl:text-5xl font-bold opacity-30 mb-3">
                  VR Headsets
                </p>
                <Button
                  text="Browse"
